...
if __name__ == "__main__" :
    ...
    incoming_purge_message_handler = MessageHandler(
        incoming_purge_message_f,
        filters=Filters.command([@Publicleechrobot.PURGE]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    status_message_handler = MessageHandler(
        status_message_f,
        filters=Filters.command([@Publicleechrobot.STATUS]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    cancel_message_handler = MessageHandler(
        cancel_message_f,
        filters=Filters.command([@Publicleechrobot.CANCEL]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    if not SHOULD_USE_BUTTONS:
        ...
        incoming_message_handler = MessageHandler(
            leech_commandi_f,
            filters=Filters.command([@Publicleechrobot.LEECH]) & Filters.chat(chats=AUTH_CHANNEL)
        )
        ...
        incoming_youtube_dl_handler = MessageHandler(
            incoming_youtube_dl_f,
            filters=Filters.command([@Publicleechrobot.YTDL]) & Filters.chat(chats=AUTH_CHANNEL)
        )
    ...
    exec_message_handler = MessageHandler(
        exec_message_f,
        filters=Filters.command([@Publicleechrobot.EXEC]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    app.add_handler(exec_message_handler)

    upload_document_handler = MessageHandler(
        upload_document_f,
        filters=Filters.command([@Publicleechrobot.UPLOAD]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    help_text_handler = MessageHandler(
        help_message_f,
        filters=Filters.command([@Publicleechrobot.HELP]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    save_thumb_nail_handler = MessageHandler(
        save_thumb_nail,
        filters=Filters.command([@Publicleechrobot.SAVETHUMBNAIL]) & Filters.chat(chats=AUTH_CHANNEL)
    )
    ...
    clear_thumb_nail_handler = MessageHandler(
        clear_thumb_nail,
        filters=Filters.command([@Publicleechrobot.CLEARTHUMBNAIL]) & Filters.chat(chats=AUTH_CHANNEL)
    )
